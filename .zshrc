...
alias mg="mega-get" 
alias y="yazi"
alias yd="yt-dlp -f 'bv*[height<=1080][ext=mp4]+ba[ext=m4a][abr<=128]/b[height<=1080][ext=mp4]/bv*+ba/b' --embed-thumbnail --embed-metadata"
alias yd720="yt-dlp -f 'bv[ext=mp4][height=720]+ba[ext=m4a][abr<=96]/b[ext=mp4][height<=720]' --embed-thumbnail --embed-metadata"
